...
namespace BarcodeLib
{
    ...
    public class Barcode: IDisposable
    {
        ...
        {
            get { return Label_Desc; }
            set { Label_Desc = value; }
        }
        /// <summary>
                ...
                default:
                    {
                        ...
                        if (IncludeLabel && IncludeLablDesc)
                        {
                ...
                using (Graphics g = Graphics.FromImage(img))
                {
                    ...
                    switch (LabelPosition)
                    {
                        case LabelPositions.BOTTOMCENTER:
                            LabelX = img.Width / 2;
                            LabelY = img.Height - (font.Height *2);
                            f.Alignment = StringAlignment.Center;
                            break;
                    ...
                    g.FillRectangle(new SolidBrush(this.BackColor), new RectangleF((float)0, (float)LabelY, (float)img.Width, (float)font.Height*2));
                    //draw datastring under the barcode image

                    g.DrawString(this.RawData, font, new SolidBrush(this.ForeColor), new RectangleF((float)0, (float)LabelY, (float)img.Width, (float)font.Height*2), f);
                    
                     g.DrawString(this.Label_Desc, font, new SolidBrush(this.ForeColor), new RectangleF((float)0, (float)LabelY+16, (float)img.Width, (float)font.Height*2), f);
