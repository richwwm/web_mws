...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ObjectDataSource ID="NetProfitDataSource" runat="server" SelectMethod="GetAllSortedDataByMerchantID"
        ...
        <SelectParameters>
            <asp:SessionParameter DefaultValue="NetProfit_USD DESC" Name="sortExpression" SessionField="SortedBy"
                Type="String" />
    ...
    <div align="left" style="width: 1042px">
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="NetProfitDayPeriodDataSource1"
            DataTextField="Displayed_date" DataValueField="date" AutoPostBack="True" OnTextChanged="DropDownList2_TextChanged"
    ...
    <asp:ListView ID="ListView1" runat="server" DataSourceID="NetProfitDataSource" OnPreRender="ListView1_PreRender"
        OnSorting="ListView1_Sorting" OnDataBound="ListView1_DataBound">
        <LayoutTemplate>
                    ...
                    <tr id="Tr1" runat="server" style="background-color: #81DAF5">
                        <th id="Th1" runat="server">
                            ...
                            <asp:ImageButton ID="SellerSKUSortButton" runat="server" Height="15px" ImageUrl="~/Images/downArrow.png"
                                OnClick="ListViewSKUImageButton_OnClick" />
                        </th>
                        <th id="Th3" runat="server">
                            QTY SOLD
                            <asp:ImageButton ID="ImageButton1" runat="server" Height="15px" ImageUrl="~/Images/downArrow.png" />
                        </th>
                        <th id="Th4" runat="server">
                            QTY RETURN
                            <asp:ImageButton ID="ImageButton2" runat="server" Height="15px" ImageUrl="~/Images/downArrow.png" />
                        </th>
                        <th id="Th2" runat="server">
                            Net Profit Per Item
                            <asp:ImageButton ID="NetProfitSortButton" runat="server" Height="15px" ImageUrl="~/Images/downArrow.png"
                                OnClick="ListViewNetProfitImageButton_OnClick" />
                        </th>
                    </tr>
                </thead>
                <tbody>
        ...
        <ItemTemplate>
            <tr id="Tr2" runat="server" style='<%# (double)Eval("Cost") <= 0?"background-color: Red":"background-color: White" %>'>
                <td valign="top">
                    <asp:Label ID="ProductTitleLabel" runat="Server" Text='<%#Eval("ProductName") %>'
                        Width="300px" />
                </td>
                <td valign="top">
                    <asp:Label ID="QTY_SOLD_Label" runat="Server" Text='<%#Eval("Total_Sold") %>' Width="60px" />
                </td>
                <td valign="top">
                    <asp:Label ID="QTY_RETURN_Label" runat="Server" Text='<%#Eval("Total_Return") %>' Width="100px" />
                </td>
                <td align="center">
        ...
        <AlternatingItemTemplate>
            <tr style='<%# (double)Eval("Cost") <=0?"background-color: Red":"background-color: Grey" %>'>
                <td valign="top">
                    <asp:Label ID="ProductTitleLabel" runat="Server" Text='<%#Eval("ProductName") %>'
                        Width="300px" />
                </td>
