<%@ Page Async="true" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <div>
            <asp:TextBox ID="SearchBox" runat="server" Height="22px" Style="margin-left: 0px;
                margin-top: 0px" Width="283px" ontextchanged="SearchBox_TextChanged"></asp:TextBox>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllSortedDataByMerchantID"
        TypeName="LabelPrintingInterface.DataSource.SellerInventorySupplyList">
        <SelectParameters>
